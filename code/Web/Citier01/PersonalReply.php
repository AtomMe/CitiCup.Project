	...
	<div class="bodywrapper">
		...
		<div class="centercontent">
			...
			<div class="pageheader notab">
				<h1 class="pagetitle">回复用户审核不通过的理由</h1>
			...
			<div class="contentwrapper">
				<div class="two_third">
					<form action="ExamineAccount.php" method="post">
						...
						<?php
						$FailMsg = '您的身份证照片太模糊，不符合要求';
						require_once "sqlTool.php";
						$sqltool = new sqlTool();
						$sql = "UPDATE user set IsAuthentication = 0 where UserName = '$username'";
						$result = $sqltool->excute_dql($sql);
						
						$sqltool = new sqlTool();
						$sql = "UPDATE user set AuthenticationFail = 1 where UserName = '$username'";
						$result = $sqltool->excute_dql($sql);
						$sqltool = new sqlTool();
						$sql = "UPDATE user set AuthenticationFailMsg = '$FailMsg' where UserName = '$username'";
						$result = $sqltool->excute_dql($sql);						
						?>
						<br /> <br /> <input type="submit" name="save" value="提交" />
					</form>                    
				</div>
				<!--two_third-->
			</div>
