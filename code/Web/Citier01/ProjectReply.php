	...
	<div class="bodywrapper">
		...
		<div class="centercontent">
			...
			<div class="contentwrapper">
				<div class="two_third">
					<form action="ExamineHelpProject.php" method="post">
						...
						<?php
						$FailMsg = '您的照片太模糊，不符合要求';
						require_once "sqlTool.php";
						$sqltool = new sqlTool();
						$sql = "UPDATE user set ProjectRequestFail = 1 where ProjectID = '$projectid'";
						$result = $sqltool->excute_dql($sql);
						
						$sqltool = new sqlTool();
						$sql = "UPDATE user set ProjectFailMsg = '$FailMsg' where ProjectID = '$projectid'";
						$result = $sqltool->excute_dql($sql);						
						?>
