	...
	<div class="bodywrapper">
		...
		<div class="centercontent">
			<div class="pageheader">
				<h1 class="pagetitle">主页</h1>
				<span class="pagedesc">页面展示网站基本信息</span>
				<ul class="hornav">
				</ul>
			</div>
			<div class="profile_about">
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;益帮人——社会企业搭建的全透明第三方P2P捐款救助平台，慈善“购买者”与慈善“需求者”通过平台直接面对面</p>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;解决捐款交易的信息不对称问题，其P2P的直接救助模式类似于淘宝C2C电子商务模式。</p>
			</div>
