					...
					<table cellpadding="0" cellspacing="0" border="0"
						...
						<?php
                         ...
                         <tr class="unread">
								...
								<td><a href="ProjectInfo.php?id=<?php echo $row['ProjectID']?>&userid=<?php echo $row['UserID'] ?>" class="title"><?php echo $row['ProjectID'];?></a></td>
								<td class="attachment"></td>
								<td class="date"><?php echo $row['ProjectDateRequest'];?></td>
							</tr>
							<?php }?>
                         </tbody>
					</table>
