	...
	<div class="bodywrapper">
		...
		<div class="centercontent">
			...
			<div class="contentwrapper">
				<div class="two_third">
					<form action="ExamineWithdraw.php" method="post">
						...
						<?php
						$FailMsg = '您的照片不真实，不符合要求';
						require_once "sqlTool.php";
						$sqltool = new sqlTool();
						$sql = "UPDATE withdraw set WithdrawRequestFail = 1 where WithdrawID = '$withdrawid'";
						$result = $sqltool->excute_dql($sql);
						
						$sqltool = new sqlTool();
						$sql = "UPDATE withdraw set ProjectFailMsg = '$FailMsg' where WithdrawID = '$withdrawid'";
						$result = $sqltool->excute_dql($sql);						
						?>
